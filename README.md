...
A modern full-stack car rental platform built with **Angular**, **Spring Boot**, **FastAPI chatbot**, and **MySQL**, featuring **JWT & Keycloak authentication**, **email notifications**, **PDF + QR booking confirmations**, **real-time chat**, **Stripe payment**, and **follower updates**.
...
- **Stripe Payment:** Secure online payment with PDF confirmation via email
...
- **Services:** CarService, BookingService, ChatService, NotificationService, EmailService, PDFService, StripePaymentService
...
- **Features:**
  ...
  - **PDF attachment sent via email upon agency approval**
...
- **Email (SMTP):** Booking confirmations, **PDF+QR documents as attachments**, follower updates
...
4. On approval:
   - **Stripe payment link sent to customer**
   - **PDF+QR confirmation generated and emailed as attachment**
...
| Feature | Screenshot |
|---------|------------|
| Stripe Payment Checkout | ![Stripe Checkout](screenshots/stripe-checkout.PNG) |
| Stripe Payment Success | ![Stripe Success](screenshots/stripe-success.PNG) |
...
| Stripe Payment Success | ![Stripe Success](screenshots/paiment.PNG) |
| Minikube Dashboard | ![Minikube Dashboard](screenshots/k8s.PNG) |
